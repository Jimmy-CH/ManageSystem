...
# 导入你的模型（根据实际路径调整）
from apps.events.models import Category, SLAStandard, Incident, Fault
from apps.events.constants import PRIORITY_CHOICES, SOURCE_CHOICES, FAULT_STATUS_CHOICES
